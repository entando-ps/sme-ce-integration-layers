...
public class CSVFileNames {
    ...
    public static final String ISTANZANUCLEOESTERNO = "istanzanucleoesterno.csv";
    public static final String MANDATOPAGAMENTONUCLEOPRINCIPALE = "mandatopagamentonucleoprincipale.csv";
    public static final String MANDATOPAGAMENTONUCLEOESTERNO = "mandatopagamentonucleoesterno.csv";
    public static final String MANDATOPAGAMENTOPVCNUCLEOPRINCIPALE = "mandatopagamentopvcnucleoprincipale.csv";
    public static final String MANDATOPAGAMENTOPVCNUCLEOESTERNO = "mandatopagamentopvcnucleoesterno.csv";
